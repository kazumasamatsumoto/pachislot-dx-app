import { SlotMachineData, SlotSymbolProbabilities, SlotProbability } from './slot-probability.interface';

export class AimJuggler implements SlotMachineData {
  machineName = 'アイムジャグラー';
  ...
  symbols: SlotSymbolProbabilities[] = [
    ...
    },
    {
      symbolName: 'レアチェリー',
      probabilities: [
        { setting: 1, probability: 1/6553.60 },
        { setting: 2, probability: 1/6553.60 },
        { setting: 3, probability: 1/6553.60 },
